...
class CustomSemanticKittiDataset(NuScenesDataset):
    ...
    def __init__(
        self, queue_length=4, bev_size=(256, 256), overlap_test=False, *args, **kwargs
    ):
    ...
    def union2one(self, queue):
        ...
        for i, each in enumerate(queue):
            ...
            if i == 0:
                ...
                # # the delta position of adjacent timestamps
                # metas_map[i]['can_bus'][:3] -= prev_pos
                # # the delta orientation of adjacent timestamps
    ...
    def get_data_info(self, index):
        ...
        if self.modality["use_camera"]:
            ...
            for cam_type, cam_info in info["cams"].items():
                ...
                lidar2img_rt = (
                    viewpad @ lidar2cam_rt
                )  # point in lidar to pixel in image
    ...
    def evaluate_occ_iou(
        ...
        for index in tqdm(range(len(occupancy_results))):
            ...
            if relabel_prediction:  # to (256, 256, 32)
                ...
                pred_occupancy = pred_occupancy.transpose(
                    2, 1, 0
                )  # value in 0, 1...,19
            ...
            if show_dir and index % save_interval == 0:
                ...
                image_save_path = osp.join(
                    image_save_dir, "{:05d}.png".format(frame_idx)
                )
    ...
    def get_voxel_prediction(self, occupancy):
        ...
        pred_occupancy = (
            np.ones(self.voxel_num, dtype=np.int64) * self.occupancy_classes
        )
