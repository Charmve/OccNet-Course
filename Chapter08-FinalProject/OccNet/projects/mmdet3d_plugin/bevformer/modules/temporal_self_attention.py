...
class TemporalSelfAttention(BaseModule):
    ...
    Args:
        ...
        init_cfg (obj:`mmcv.ConfigDict`): The Config for initialization.
            Default: None.
        num_bev_queue (int): In this version, \
            we only use one history BEV and one currenct BEV. \
    ...
    def forward(
        ...
        **kwargs,
        ...
        if torch.cuda.is_available() and value.is_cuda:
            ...
            # using fp16 deformable attention is unstable because
            # it performs many sum operations
        ...
        # output = multi_scale_deformable_attn_pytorch_2d(
        #     value, spatial_shapes, sampling_locations, attention_weights
        # )
...
def multi_scale_deformable_attn_pytorch_2d(
