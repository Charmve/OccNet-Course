...
class DCNv3_pytorch(nn.Module):
    def __init__(
        ...
        # you'd better set _d_per_group to a power of 2 which
        # is more efficient in our CUDA implementation #noqa: E501
    ...
    def forward(self, input):
        ...
        if self.center_feature_scale:
            ...
            # -> N, H, W, groups, _d_per_group -> N, H, W, channels #noqa: E501
...
class DCNv3(nn.Module):
    def __init__(
        ...
        dw_kernel_size = dw_kernel_size if dw_kernel_size is not None else kernel_size
        # you'd better set _d_per_group to a power of 2 which
        # is more efficient in our CUDA implementation
        if not _is_power_of_2(_d_per_group):
            warnings.warn(
                "You'd better set channels in DCNv3 to make the dimension of each attention head a power of 2 "  # noqa: E501
                "which is more efficient in our CUDA implementation."
            )
